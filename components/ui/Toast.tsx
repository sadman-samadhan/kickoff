...
export function Toast({ message, onClose, duration = 4000 }: ToastProps) {
  ...
  return (
    <div className={`fixed top-4 left-4 right-4 z-[100] flex justify-center transition-all duration-300 ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0 pointer-events-none'}`}>
